const i18n = {
    uk: {
        ...
        copy_url:             'Скопіювати',
        unclaimed_hint:       'Ця таблиця ще не прив\'язана — будь-хто з доступом може її редагувати, і вона не потрапляє у "Мої таблиці". Прив\'яжи її до себе, щоб бачити в своєму списку та обмежити редагування лише собою.',
        claim_table:          'Прив\'язати до себе',
    ...
    en: {
        ...
        copy_url:             'Copy',
        unclaimed_hint:       'This table isn\'t claimed yet — anyone with access can edit it, and it won\'t show up in "My tables". Claim it to see it in your list and restrict editing to yourself.',
        claim_table:          'Claim as mine',
        back:                 'Back',
    ...
    ru: {
        ...
        unclaimed_hint:       'Эта таблица ещё не привязана — редактировать её может любой с доступом, и она не попадает в "Мои таблицы". Привяжи её к себе, чтобы видеть в своём списке и ограничить редактирование только собой.',
        claim_table:          'Привязать к себе',
        back:                 'Назад',
